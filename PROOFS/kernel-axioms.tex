...
\begin{itemize}
    ...
    \item \textbf{Fourth-Class Replicator} ($R_4$) --- Reserved. Definition
...
where $F_n$ is fidelity after $n$ transformations and $\epsilon_i$ is noise introduced
at step $i$.

\textbf{Derivation:}
\[ \lim_{n \to \infty} T^n(I) = \text{Noise} \]
Serial transformations accumulate error multiplicatively.

\textbf{Limit Condition:}
\[ \lim_{n \to \infty} F_n = 0 \]

\textbf{System Implication:} Unchecked serial transformations (summaries of summaries,
translations of translations) produce unbounded fidelity degradation and eventual
systemic collapse.
